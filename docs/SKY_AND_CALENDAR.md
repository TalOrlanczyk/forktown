...
- `/tests/manual/sky.html` on the development server: inspect day, night, and moon phases using the real town renderer. These controls exist only in the manual fixture and do not change the live clock.
